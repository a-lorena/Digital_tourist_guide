...
public class AccAdapter extends FirestoreRecyclerAdapter<AccModel, AccAdapter.AccHolder> {
	Context context;
	OnItemClickListener listener;
	String recyclerOrientation;

	public AccAdapter(String recyclerOrientation, Context context, @NonNull FirestoreRecyclerOptions<AccModel> options) {
		super(options);
	...
	@Override
	protected void onBindViewHolder(@NonNull AccAdapter.AccHolder holder, int position, @NonNull AccModel model) {
	...
	@NonNull
	@Override
	public AccAdapter.AccHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View v;
		...
		return new AccHolder(v, listener);
	}
	...
	public class AccHolder extends RecyclerView.ViewHolder {
		...
		public AccHolder(@NonNull View view, OnItemClickListener listener) {
			super(view);
	...
	public void setOnItemClickListener (AccAdapter.OnItemClickListener listener) {
