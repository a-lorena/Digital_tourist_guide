...
public class MonumentAdapter extends FirestoreRecyclerAdapter<MonumentModel, MonumentAdapter.MonumentHolder> {
	Context context;
	String recyclerOrientation;
	OnItemClickListener listener;

	public MonumentAdapter(String recyclerOrientation, Context context, @NonNull FirestoreRecyclerOptions<MonumentModel> options) {
		super(options);
	...
	@Override
	protected void onBindViewHolder(@NonNull MonumentAdapter.MonumentHolder holder, int position, @NonNull MonumentModel model) {
		String imageName = model.getImageName();
		StorageReference storage = FirebaseStorage.getInstance().getReference("images_monuments/" + imageName);
	...
	@NonNull
	@Override
	public MonumentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View v;
		...
		return new MonumentHolder(v, listener);
	}
	...
	public class MonumentHolder extends RecyclerView.ViewHolder {
		...
		public MonumentHolder(@NonNull View view, OnItemClickListener listener) {
			super(view);
	...
	public void setOnItemClickListener (MonumentAdapter.OnItemClickListener listener) {
