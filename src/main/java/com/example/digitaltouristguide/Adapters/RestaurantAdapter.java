...
public class RestaurantAdapter extends FirestoreRecyclerAdapter<RestaurantModel, RestaurantAdapter.RestaurantHolder> {
	Context context;
	OnItemClickListener listener;
	String recyclerOrientation;

	public RestaurantAdapter(String recyclerOrientation, Context context, @NonNull FirestoreRecyclerOptions<RestaurantModel> options) {
		super(options);
	...
	@Override
	protected void onBindViewHolder(@NonNull RestaurantAdapter.RestaurantHolder holder, int position, @NonNull RestaurantModel model) {
	...
	public RestaurantAdapter.RestaurantHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		...
		return new RestaurantHolder(v, listener);
	}
	...
	public class RestaurantHolder extends RecyclerView.ViewHolder {
		...
		public RestaurantHolder(@NonNull View view, OnItemClickListener listener) {
			super(view);
